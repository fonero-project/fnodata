...
func TestNewProposalsDB(t *testing.T) {
	var count int
	inputURLPath := "https://proposals.fonero.org"
	expectedPath := "https://proposals.fonero.org/api/v1"
...
func TestGenerateCustomID(t *testing.T) {
	...
	td := []testData{
		...
		{
			title:    "Fonero Bug Bounty Proposal",
			customID: "fonero-bug-bounty-proposal",
		},
		{
		...
		{
			title:    "Proposed Statement Of Work (SOW) For Fonero Blockchain Wallet Tutorial Campaign",
			customID: "proposed-statement-of-work-sow-for-fonero-blockchain-wallet-tutorial-campaign",
		},
	}
