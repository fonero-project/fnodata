...
const (
	defaultConfigFilename = "fnodata.conf"
	defaultLogFilename    = "fnodata.log"
...
var (
	defaultHomeDir           = fnoutil.AppDataDir("fnodata", false)
...
type config struct {
	...
	HomeDir      string `short:"A" long:"appdata" description:"Path to application home directory" env:"FNODATA_APPDATA_DIR"`
	ConfigFile   string `short:"C" long:"configfile" description:"Path to configuration file" env:"FNODATA_CONFIG_FILE"`
	DataDir      string `short:"b" long:"datadir" description:"Directory to store data" env:"FNODATA_DATA_DIR"`
	LogDir       string `long:"logdir" description:"Directory to log output." env:"FNODATA_LOG_DIR"`
	OutFolder    string `short:"f" long:"outfolder" description:"Folder for file outputs" env:"FNODATA_OUT_FOLDER"`
	ShowVersion  bool   `short:"V" long:"version" description:"Display version information and exit"`
	TestNet      bool   `long:"testnet" description:"Use the test network (default mainnet)" env:"FNODATA_USE_TESTNET"`
	SimNet       bool   `long:"simnet" description:"Use the simulation test network (default mainnet)" env:"FNODATA_USE_SIMNET"`
	DebugLevel   string `short:"d" long:"debuglevel" description:"Logging level {trace, debug, info, warn, error, critical}" env:"FNODATA_LOG_LEVEL"`
	Quiet        bool   `short:"q" long:"quiet" description:"Easy way to set debuglevel to error" env:"FNODATA_QUIET"`
	HTTPProfile  bool   `long:"httpprof" short:"p" description:"Start HTTP profiler." env:"FNODATA_ENABLE_HTTP_PROFILER"`
	HTTPProfPath string `long:"httpprofprefix" description:"URL path prefix for the HTTP profiler." env:"FNODATA_HTTP_PROFILER_PREFIX"`
	CPUProfile   string `long:"cpuprofile" description:"File for CPU profiling." env:"FNODATA_CPU_PROFILER_FILE"`
	...
	// EmailSubject string `long:"emailsubj" description:"Email subject. (default \"fnodataapi transaction notification\")"`

	// RPC client options
	FnodUser         string `long:"fnoduser" description:"Daemon RPC user name" env:"FNODATA_FNOD_USER"`
	FnodPass         string `long:"fnodpass" description:"Daemon RPC password" env:"FNODATA_FNOD_PASS"`
...
func netName(chainParams *netparams.Params) string {
	...
	// TestNet2 was removed entirely for fnod 1.3.0. Compile check!
