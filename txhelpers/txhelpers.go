...
func TxFeeRate(msgTx *wire.MsgTx) (fnoutil.Amount, fnoutil.Amount) {
	...
	return fnoutil.Amount(amtIn - amtOut), fnoutil.Amount(FeeRate(amtIn, amtOut, txSize))
}
...
// hash) address. See https://github.com/fonero-project/fnodata/issues/358 for details.
...
// If the address decoded successfully as a Fonero address, it is checked
