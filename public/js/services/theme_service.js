...
function toggleToDarkClasses (body) {
  sunIcon.classList.remove('fnoicon-sun-fill')
  sunIcon.classList.add('fnoicon-sun-stroke')
  body.classList.add('darkBG')
}
function toggleToLightClasses (body) {
  body.classList.remove('darkBG')
  sunIcon.classList.remove('fnoicon-sun-stroke')
  sunIcon.classList.add('fnoicon-sun-fill')
}
