        ...
        plotGraph(chartName, data) {
            ...
            switch(chartName){
                case 'ticket-price': // price graph
                    d = ticketsFunc(data)
                    _.assign(gOptions, mapDygraphOptions(d, ['Date', 'Price'], true, 'Price (Fonero)', 'Date', undefined, false, false))
                break;
                ...
                case 'fee-per-block': // block fee graph
                    d = blockFeeFunc(data)
                    _.assign(gOptions, mapDygraphOptions(d, ['Block Height', 'Total Fee'], false, 'Total Fee (FNO)', 'Block Height',
                    undefined, true, false))
                break;
