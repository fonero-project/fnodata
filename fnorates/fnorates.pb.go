...
func (*ExchangeSubscription) Descriptor() ([]byte, []int) {
	return fileDescriptor_fnorates_9bf93ce756f00f36, []int{0}
}
...
func (*ExchangeRateUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_fnorates_9bf93ce756f00f36, []int{1}
}
...
func (*ExchangeRateUpdate_DepthPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_fnorates_9bf93ce756f00f36, []int{1, 1}
}
...
func (*ExchangeRateUpdate_DepthData) Descriptor() ([]byte, []int) {
	return fileDescriptor_fnorates_9bf93ce756f00f36, []int{1, 2}
}
...
func (*ExchangeRateUpdate_Candlestick) Descriptor() ([]byte, []int) {
	return fileDescriptor_fnorates_9bf93ce756f00f36, []int{1, 3}
}
...
func (*ExchangeRateUpdate_Candlesticks) Descriptor() ([]byte, []int) {
	return fileDescriptor_fnorates_9bf93ce756f00f36, []int{1, 4}
}
...
func init() {
	proto.RegisterType((*ExchangeSubscription)(nil), "fnorates.ExchangeSubscription")
	proto.RegisterType((*ExchangeRateUpdate)(nil), "fnorates.ExchangeRateUpdate")
	proto.RegisterMapType((map[string]float64)(nil), "fnorates.ExchangeRateUpdate.IndicesEntry")
	proto.RegisterType((*ExchangeRateUpdate_DepthPoint)(nil), "fnorates.ExchangeRateUpdate.DepthPoint")
	proto.RegisterType((*ExchangeRateUpdate_DepthData)(nil), "fnorates.ExchangeRateUpdate.DepthData")
	proto.RegisterType((*ExchangeRateUpdate_Candlestick)(nil), "fnorates.ExchangeRateUpdate.Candlestick")
	proto.RegisterType((*ExchangeRateUpdate_Candlesticks)(nil), "fnorates.ExchangeRateUpdate.Candlesticks")
}
...
// FNORatesClient is the client API for FNORates service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type FNORatesClient interface {
	SubscribeExchanges(ctx context.Context, in *ExchangeSubscription, opts ...grpc.CallOption) (FNORates_SubscribeExchangesClient, error)
}
...
func NewFNORatesClient(cc *grpc.ClientConn) FNORatesClient {
	return &dCRRatesClient{cc}
}

func (c *dCRRatesClient) SubscribeExchanges(ctx context.Context, in *ExchangeSubscription, opts ...grpc.CallOption) (FNORates_SubscribeExchangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_FNORates_serviceDesc.Streams[0], "/fnorates.FNORates/SubscribeExchanges", opts...)
	if err != nil {
		return nil, err
	}
...
type FNORates_SubscribeExchangesClient interface {
...
// FNORatesServer is the server API for FNORates service.
type FNORatesServer interface {
	SubscribeExchanges(*ExchangeSubscription, FNORates_SubscribeExchangesServer) error
}

func RegisterFNORatesServer(s *grpc.Server, srv FNORatesServer) {
	s.RegisterService(&_FNORates_serviceDesc, srv)
}

func _FNORates_SubscribeExchanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExchangeSubscription)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(FNORatesServer).SubscribeExchanges(m, &dCRRatesSubscribeExchangesServer{stream})
}

type FNORates_SubscribeExchangesServer interface {
...
var _FNORates_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fnorates.FNORates",
	HandlerType: (*FNORatesServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SubscribeExchanges",
			Handler:       _FNORates_SubscribeExchanges_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "fnorates.proto",
}

func init() { proto.RegisterFile("fnorates.proto", fileDescriptor_fnorates_9bf93ce756f00f36) }

var fileDescriptor_fnorates_9bf93ce756f00f36 = []byte{
