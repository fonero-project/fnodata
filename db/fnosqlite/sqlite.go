...
const (
	...
	TableNameSummaries = "fnodata_block_summary"
	// TableNameStakeInfo is name of the table used to store extended stake info
	TableNameStakeInfo = "fnodata_stakeinfo_extended"
...
type DB struct {
	*sql.DB
	...
	// Drop shutdownFnodata when the "database is locked" error is mitigated.
	// See https://github.com/fonero-project/fnodata/issues/1133 for more info.
	shutdownFnodata func()
...
// until resolved. See https://github.com/fonero-project/fnodata/issues/1133 for info.
...
func (db *DB) JustifyTableStructures(dbInfo *DBInfo) error {
	...
	bkpPath := filepath.Join(directory, "fnodata.nosidechains-bkp.db")
