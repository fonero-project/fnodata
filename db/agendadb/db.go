...
// AgendaTagged has the same fields as fnojson.Agenda, but with the Id field
...
type AgendaTagged struct {
	...
	Choices        []fnojson.Choice `json:"choices"`
	VoteVersion    uint32           `json:"voteversion"`
}

// ChoiceLabeled embeds fnojson.Choice along with the AgendaID for the choice,
...
func CheckForUpdates(client *rpcclient.Client) error {
	...
	// https://docs.fonero.org/getting-started/user-guides/agenda-voting/#voting-archive
