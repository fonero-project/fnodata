...
- db/fnopg: Charts data updates could use incremental changes. (Issue)
...
1. Fork the repository on GitHub.  Just click the little Fork button at https://github.com/fonero-project/fnodata

![image](https://user-images.githubusercontent.com/6109680/47858277-b8910480-ddb9-11e8-9088-a4d1c7b0805d.png)

2. Clone your newly forked fnodata repository

```sh
git clone git@github.com:my-user-name/fnodata.git
```
...
```sh
git remote add upstream https://github.com/fonero-project/fnodata.git
git fetch upstream
...
Since the Fonero repo may have changes that you do not have locally, you'll want to pull in any changes and rebase.
...
[Code of Conduct](https://github.com/fonero-project/fnodata/blob/master/CODE_OF_CONDUCT.md).
...
`dcdrrates/runprotoc.sh` to recompile `fnorates.pb.go`.
