...
var (
	...
	//rebuilddbHomeDir            = fnoutil.AppDataDir("rebuilddb", false)
	...
	defaultDBUser      = "fnodata"
	defaultDBPass      = "bananas"
	defaultDBTableName = "fnodata"
...
type config struct {
	...
	// RPC client options
	FnodUser         string `long:"fnoduser" description:"Daemon RPC user name"`
	FnodPass         string `long:"fnodpass" description:"Daemon RPC password"`
	FnodServ         string `long:"fnodserv" description:"Hostname/IP and port of fnod RPC server to connect to (default localhost:9209, testnet: localhost:19209, simnet: localhost:19556)"`
	FnodCert         string `long:"fnodcert" description:"File containing the fnod certificate file"`
...
func cleanAndExpandPath(path string) string {
	...
	if strings.HasPrefix(path, "~") {
		homeDir := filepath.Dir(fnodHomeDir)
...
// const (
//     defaultDBTableName = "fnodata"
//     defaultDBUserName = "fnodata"
//     defaultDBPass = "fnopassword"
//     defaultDBFileName = "fnodata.sqlt.dat"
//     defaultDBHostPort = "127.0.0.1:3660"
// )

// type configuration struct {
//     DaemonHostPort string `json:"fnodhost"`
//     DaemonUser string `json:"fnoduser"`
//     DaemonPass string `json:"fnodpass"`
