...
const (
	AppName  string = "fnodata"
	AppMajor uint   = 5
	AppMinor uint   = 0
	AppPatch uint   = 0
)

// go build -v -o fnodata -ldflags "-X github.com/fonero-project/fnodata/version.appPreRelease= -X github.com/fonero-project/fnodata/version.appBuild=`git rev-parse --short HEAD`"
var (
