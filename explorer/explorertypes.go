...
type TrimmedBlockInfo struct {
	...
	Total        float64
	Fees         float64
	Subsidy      *fnojson.GetBlockSubsidyResult
	Votes        []*TrimmedTxInfo
...
type HomeInfo struct {
	...
	TotalLockedFNO        float64        `json:"total_locked_fno"`
	HashRate              float64        `json:"hash_rate"`
	// HashRateChange defines the hashrate change in 24hrs
	HashRateChange float64 `json:"hash_rate_change"`
}

// BlockSubsidy is an implementation of fnojson.GetBlockSubsidyResult
