...
func (s *BlockDataToMemdb) GetHeader(idx int) *fnojson.GetBlockHeaderVerboseResult {
	if idx < 0 {
		return nil
	}
	if s.mtx != nil {
...
func (s *BlockDataToMemdb) GetFeeInfo(idx int) *fnojson.FeeInfoBlock {
	if idx < 0 {
		return nil
	}
	if s.mtx != nil {
...
func (s *BlockDataToMemdb) GetStakeDiffEstimate(idx int) *fnojson.EstimateStakeDiffResult {
	if idx < 0 {
		return nil
	}
	if s.mtx != nil {
